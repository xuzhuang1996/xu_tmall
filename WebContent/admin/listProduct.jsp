...
<div class="workingArea">
    ...
    <div class="pageDiv">
        <%@include file="../include/admin/adminPage_complete.jsp" %>
    </div>
                ...
                <table class="addTable">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input id="orignalPrice" value="99.98" name="orignalPrice" type="text"
                                   class="form-control">
                        </td>
                    </tr>
                    <tr>
                        <td>优惠价格</td>
                        <td>
                            <label for="promotePrice">
                            </label>
                            <input id="promotePrice" value="19.98" name="promotePrice" type="text"
                                   class="form-control">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <input id="stock" value="99" name="stock" type="text"
                                   class="form-control">
                        </td>
                    </tr>
                    <tr class="submitTR">
